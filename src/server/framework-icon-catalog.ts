...
export const FRAMEWORK_ICON_CATALOG: FrameworkIconCatalogEntry[] = [
  ...
  { slug: "koa", name: "Koa", search: "Koa", dependencies: ["koa"], website: "https://koajs.com/" },
  { slug: "adonisjs", name: "AdonisJS", search: "AdonisJS", dependencyPrefixes: ["@adonisjs/"], website: "https://adonisjs.com/" },
