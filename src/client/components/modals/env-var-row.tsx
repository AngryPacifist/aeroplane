...
export function EnvVarRow({ item, onSave, onDelete, busy }: EnvVarRowProps) {
  ...
  if (editing) {
    return (
      <form
        onSubmit={handleSave}
        className="grid grid-cols-[1fr_1fr_auto] items-center gap-3 border-b border-zinc-800 bg-zinc-900/40 px-5 py-3 transition-colors duration-200"
      >
        <div>
          <FormInput
            value={editKey}
  ...
  return (
    <div className="grid grid-cols-[1fr_1fr_auto] items-center gap-4 border-b border-zinc-800 px-5 py-4 last:border-b-0 bg-zinc-900/10 hover:bg-zinc-900/30 transition-colors duration-200">
